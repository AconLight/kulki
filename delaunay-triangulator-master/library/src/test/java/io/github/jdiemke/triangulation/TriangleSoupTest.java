...
public class TriangleSoupTest {
    ...
    public void testAddTriangle() {
        TriangleSoup soup = new TriangleSoup();
        soup.add(new Triangle2D(new Vector2D(0, 0, null), new Vector2D(1, 0, null), new Vector2D(1, 1, null)));
    ...
    public void testRemoveTriangle() {
        TriangleSoup soup = new TriangleSoup();
        Triangle2D triangle = new Triangle2D(new Vector2D(0, 0, null), new Vector2D(1, 0, null), new Vector2D(1, 1, null));
