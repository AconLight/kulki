...
public class DelaunayTriangulator {
    ...
    public void triangulate() throws NotEnoughPointsException {
        ...
        Vector2D p1 = new Vector2D(0.0d, 3.0d * maxOfAnyCoordinate, null);
        Vector2D p2 = new Vector2D(3.0d * maxOfAnyCoordinate, 0.0d, null);
        Vector2D p3 = new Vector2D(-3.0d * maxOfAnyCoordinate, -3.0d * maxOfAnyCoordinate, null);
